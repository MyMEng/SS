...
Being able to specify the string format specifier allows us to use \emph{printf} method in order to either crash a program, look up values on stack and memory and even modify content at specific memory locations with a specified value. We used the following features of \emph{printf} specifier string:
\begin{itemize}
