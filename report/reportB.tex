...
We use our script\ref{script1} to create the RST packet on behalf of the victim at the IP address \texttt{10.0.2.4}.\\
...
We also successfully modified the worm in a way that posted message contains the the worm itself. The souce code is available in \emph{appendix}~\ref{app:javasc2}.
